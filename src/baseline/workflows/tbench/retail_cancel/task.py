...
def task1_llm_process(args, dag_id, backend_data, instruction, vllm_manager= None, backend= "huggingface"):
    """
...
def task2_execute_cancel(args, dag_id, extracted_info, backend_data):
    """
...
def task3_output_result(args, dag_id, all_results):
    """
    工作流的第3步：输出取消操作的最终结果。
    """
    import time
